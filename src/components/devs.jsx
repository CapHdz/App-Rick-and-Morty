                ...
                <div className='row'>
                    <div className='col-sm-3'>
                        <div className='card m-2'>
                            ...
                            <div className='card-body'>
                                <h5 className='card-title text-center'>Willian Hernández</h5>
                    ...
                    <div className='col-sm-3'>
                        <div className='card m-2'>
                            ...
                            <div className='card-body'>
                                <h5 className='card-title text-center'>Moises Centeno</h5>
                                <ul className="list-group list-group-flush">
                                    <li className="list-group-item">Web developer</li>
                    ...
                    <div className='col-sm-3'>
                        <div className='card m-2'>
                            ...
                            <div className='card-body'>
                                <h5 className='card-title text-center'>Pablo Zuniga</h5>
                                <ul className="list-group list-group-flush">
                                    <li className="list-group-item">Web developer</li>
                    ...
                    <div className='col-sm-3'>
                        <div className='card m-2'>
                            ...
                            <div className='card-body'>
                                <h5 className='card-title text-center'>Juan Díaz</h5>
                                <ul className="list-group list-group-flush">
                                    <li className="list-group-item">Web developer</li>
                                    <li className="list-group-item">Componentes de login,logout y perfil</li>
                                    <li className="list-group-item">Integracion de Auth0</li>
                    ...
                    <div className='col-sm-3'>
                        <div className='card m-2'>
                            ...
                            <div className='card-body'>
                                <h5 className='card-title text-center'>Marlene Montoya</h5>
                                <ul className="list-group list-group-flush">
                                    <li className="list-group-item">Web developer</li>
                    ...
                    <div className='col-sm-3'>
                        <div className='card m-2'>
                            ...
                            <div className='card-body'>
                                <h5 className='card-title text-center'>Josue Sotoy</h5>
                                <ul className="list-group list-group-flush">
                                    <li className="list-group-item">Web developer</li>
                                    <li className="list-group-item">Componente de desarrolladores</li>
                                </ul>
